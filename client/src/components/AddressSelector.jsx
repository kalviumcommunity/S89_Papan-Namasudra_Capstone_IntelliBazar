...
import { FaPlus, FaMapMarkerAlt, FaHome, FaBuilding, FaCheck, FaEdit } from "react-icons/fa";
  ...
  const handleSaveAddress = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        onAddressSelect(response.data.data);
        resetForm();
      }
    } catch (error) {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center px-3 py-2 text-blue-600 hover:text-blue-800 font-semibold"
        >
      ...
      {addresses.length === 0 ? (
        <div className="text-center py-8 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
          ...
          <h4 className="text-lg font-semibold text-gray-600 mb-2">No Addresses Found</h4>
          <p className="text-gray-500 mb-4">Add your first address to continue</p>
          <button
            onClick={handleAddAddress}
