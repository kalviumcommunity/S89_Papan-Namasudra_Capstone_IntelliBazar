...
import { FaStar, FaRegStar, FaHeart, FaCheckCircle, FaSearch, FaFutbol } from "react-icons/fa";
  ...
  return (
    <div className="min-h-screen bg-gray-100 w-full p-0">
      <div className="w-full">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-emerald-600 to-green-600 text-white py-16 px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-4">
              <FaFutbol className="text-4xl mr-3" />
              <h1 className="text-5xl font-bold">Sports</h1>
            </div>
            <p className="text-xl mb-6">
              Gear up for your favorite sports with our premium equipment collection
            </p>
            <div className="text-lg">
              <span className="bg-white bg-opacity-20 px-4 py-2 rounded-full">
                {sportsProducts.length} Sports Products Available
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex gap-2 mt-auto">
                      <button
                        ...
                        className="flex-1 bg-emerald-600 text-white rounded-lg py-2 font-semibold hover:bg-emerald-700 transition"
                      >
                        Buy Now
                      </button>
                      <button
            ...
            {filteredAndSortedProducts.length === 0 && (
              <div className="text-center py-12">
                <p className="text-gray-500 text-lg">No sports equipment found matching your search.</p>
                <button
                  onClick={() => {
                    setSearchTerm("");
