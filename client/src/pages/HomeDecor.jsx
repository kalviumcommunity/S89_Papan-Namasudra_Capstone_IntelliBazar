...
import { FaStar, FaRegStar, FaHeart, FaCheckCircle, FaSearch, FaHome } from "react-icons/fa";
...
const HomeDecor = () => {
  ...
  const filteredAndSortedProducts = useMemo(() => {
    let filtered = homeDecorProducts;
  ...
  return (
    <div className="min-h-screen bg-gray-100 w-full p-0">
      <div className="w-full">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-green-600 to-teal-600 text-white py-16 px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-4">
              <FaHome className="text-4xl mr-3" />
              <h1 className="text-5xl font-bold">Home Decor</h1>
            </div>
            <p className="text-xl mb-6">
              Transform your space with our beautiful home decoration collection
            </p>
            <div className="text-lg">
              <span className="bg-white bg-opacity-20 px-4 py-2 rounded-full">
                {homeDecorProducts.length} Home Decor Items Available
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex gap-2 mt-auto">
                      <button
                        ...
                        className="flex-1 bg-green-600 text-white rounded-lg py-2 font-semibold hover:bg-green-700 transition"
                      >
                        Buy Now
                      </button>
                      <button
            ...
            {filteredAndSortedProducts.length === 0 && (
              <div className="text-center py-12">
                <p className="text-gray-500 text-lg">No home decor items found matching your search.</p>
                <button
                  onClick={() => {
                    setSearchTerm("");
