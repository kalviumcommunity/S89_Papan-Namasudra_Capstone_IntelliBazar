...
import { FaStar, FaRegStar, FaHeart, FaCheckCircle, FaSearch, FaBook } from "react-icons/fa";
  ...
  return (
    <div className="min-h-screen bg-gray-100 w-full p-0">
      <div className="w-full">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-amber-600 to-yellow-600 text-white py-16 px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-4">
              <FaBook className="text-4xl mr-3" />
              <h1 className="text-5xl font-bold">Books</h1>
            </div>
            <p className="text-xl mb-6">
              Explore worlds of knowledge and imagination through our book collection
            </p>
            <div className="text-lg">
              <span className="bg-white bg-opacity-20 px-4 py-2 rounded-full">
                {booksProducts.length} Books Available
              </span>
            </div>
          </div>
        </div>
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex gap-2 mt-auto">
                      <button
                        ...
                        className="flex-1 bg-amber-600 text-white rounded-lg py-2 font-semibold hover:bg-amber-700 transition"
                      >
                        Buy Now
                      </button>
                      <button
